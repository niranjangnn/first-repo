									...
									<div class="widget-main">
										...
										<form action="operations" method="post">
											<fieldset>
												...
												</label><label for="form-field-mask-1">
																Date of birth
																
															</label>
												 <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="date" name="bdate" class="form-control" placeholder="bdate" id="form-field-mask-1" />
												 ...
												 <label class="block clearfix"> <span
													...
													<select name="acctype">
                                                        ...
                                                        <option value="current">current</option>
                                                            ...
                                                            </select>												<i class="ace-icon fa fa-calendar"></i>
												</span>
