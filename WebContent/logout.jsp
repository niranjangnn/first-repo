								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i> Your session time information
...
<%
		...
		long interval = (long) sess2.getAttribute("interval");
		
	%>
	
	
  <h4> <b>
	<br>session duration  <%=interval%> seconds
	<br> click here to login -> <a href=login.jsp> login</a></b></h4>
